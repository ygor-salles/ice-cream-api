...
class SaleService {
    ...
    async create(data, hostLifeasierOrigin) {
        const sale = this.repositorySale.create(Object.assign(Object.assign({}, data), { isPaid: hostLifeasierOrigin ? false : data.isPaid }));
